...
## \defgroup init_SRP_vanilla init_SRP_test - an initialization script for compare_SRP_test.py
##   @{
## A script used to run the vanilla batch without SRP in the reference EOMs
#
# Overview {#overview}
# ====
#
# Purpose
# -----
# This module is nearly identical to \ref init_vanilla. The sole difference is an implemented change to remove SRP from the EOMs used in the creation of a reference trajectory. Because of this, the script is one piece of a methodology for tracking the effectiveness of the batch filter software in the face of incomplete reference EOMs. This script is called so that \ref compare_SRP can unpack the results and compare them to other approaches. 
#
# Contents
# -----
# Just as in \ref init_vanilla, `init_SRP_test.py` script contains a secondary function and a main function:
#
# - `main`
# - `writingText`
#
...
# `main`
# -----
# In order to set the stage for the comparison test of \ref compare_SRP , this function runs a batch filter with SRP in the creation of measured data, but leaves out this force model in the reference propagator. Because of this ommission, the results can be compared with outputs of \ref init_vanilla , \ref init_acc , and \ref init_SRP_acc . This comparison can then be used to evaluate the performance of all four approaches.
#
# The first and most signficiant difference between this script and that of \ref init_vanilla is the line:
# ~~~~~~~~~~~~~~~~{.py}
...
# ~~~~~~~~~~~~~~~~
# This line simply saves the results of this script to files with names different than those of \ref init_vanilla ("nominal").
# 
## @}
