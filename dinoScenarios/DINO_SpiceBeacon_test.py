...
#dynProcess.taskName = "DynamicsTask"
...
# new module created in Basilisk for non-gravity Spice Objects

spiceBodyList = []

beacon1SpiceBody = spiceBeacon.SpiceBodyData()
beacon1SpiceBody.bodyInMsgName = "ceres_planet_data"
beacon1SpiceBody.outputMsgName = "ceres_display_frame_data"
beacon1SpiceBody.radEquator = 1000.0    # meters
beacon1SpiceBody.geo_albedo = 0.2
spiceBodyList.append(beacon1SpiceBody)

beacon2SpiceBody = spiceBeacon.SpiceBodyData()
beacon2SpiceBody.bodyInMsgName = "vesta_planet_data"
beacon2SpiceBody.outputMsgName = "vesta_display_frame_data"
beacon2SpiceBody.radEquator = 500.0     # meters
beacon2SpiceBody.geo_albedo = 0.4
spiceBodyList.append(beacon2SpiceBody)
...
# spiceObject.UTCCalInit = "11 JUL 2020 00:28:30.0"
...
##########################################################
# initial spacecraft position and velocity vector puled from spice file
##########################################################
...
#messageMap[beacon1GravBody.bodyInMsgName] = beacon1ConvertName
#messageMap[beacon1SpiceBody.bodyInMsgName] = beacon1ConvertName
#messageMap[beacon2SpiceBody.bodyInMsgName] = beacon2ConvertName

ephemConvert.messageNameMap = ephemeris_converter.map_string_string(messageMap)

print ''
print 'Beacon logThisMessage Start'
#scSim.TotalSim.logThisMessage(beacon1GravBody.bodyInMsgName, samplingTime)
#scSim.TotalSim.logThisMessage(spiceObject.SpicePlanetStateSimMsg, samplingTime)
#scSim.TotalSim.logThisMessage(beacon1SpiceBody.bodyInMsgName, samplingTime)
#scSim.TotalSim.logThisMessage(beacon1SpiceBody.bodyInMsgName, samplingTime)
print 'Beacon logThisMessage Finish'
...
pos_beacon1 = scSim.pullMessageLogData(beacon1SpiceBody.bodyInMsgName + '.PositionVector', range(3))
pos_beacon2 = scSim.pullMessageLogData(beacon2SpiceBody.bodyInMsgName + '.PositionVector', range(3))
